...
if ($jwt) {
    ...
    try {
        ...
        if ($administrator_sites->checkIAT() && $administrator_sites->checkSUB()) {
            ...
            //есть ли в базе информация об администраторе площадок
            $information_data = $administrator_sites->information_administrator_sites();
            ...
            if ($information_data) {
                ...
                echo json_encode(array(
                    ...
                    "data" => array(
                        ...
                        "phone" => $administrator_sites->phone,
                        "id_city" => $administrator_sites->id_city
                    )
                ));
            }
        }
